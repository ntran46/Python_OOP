...
class AddPatientPopup(tk.Frame):
    ...
    def __init__(self, parent, close_callback):
        ...
        ttk.Label(self, text="Room Number:").grid(row=6, column=1)
        self.room_num = ttk.Entry(self)
        self.room_num.grid(row=6, column=2)
        ttk.Label(self, text="Bill Payment:").grid(row=7, column=1)
        self.bill = ttk.Entry(self)
        self.bill.grid(row=7, column=2)
