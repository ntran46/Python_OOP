...
class Doctor(Person):
    ...
    def __init__(self, first_name: str, last_name: str, date_of_birth: str, address: str, office_num: int,
                 income: int):
    ...
    def get_description(self):
        ...
        return f"The doctor {self._firstName} {self._lastName}, ID number {self._id}, "\
               f"born in {self._date_of_birth}, works in office room {self._office_num}."
